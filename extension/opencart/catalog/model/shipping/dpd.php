 ...
 * Class Dpd
 *
 * Can be called from $this->load->model('extension/opencart/shipping/dpd');
 *
...
class Dpd extends \Opencart\System\Engine\Model {
	...
	public function getQuote(array $address): array {
       ...
       /*
		...
		$results = $this->model_localisation_geo_zone->getGeoZone((int)$this->config->get('shipping_dpd_geo_zone_id'), (int)$address['country_id'], (int)$address['zone_id']);
